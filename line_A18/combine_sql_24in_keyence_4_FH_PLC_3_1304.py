                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        while type(img1_orgin) == type(None):
                            ...
                            for path1 in glob.glob(filename1 + '/*'):
                                img1_orgin = cv2.imread(path1)
                        try:
                            img1_orgin = img1_orgin[:,150:1450]
                        except:
                            pass
            ...
            for filename2 in glob.glob('C:/FH/camera2/*'):
                for path2 in glob.glob(filename2 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        try:
                            img2_orgin = img2_orgin[100:1200,:]
                        except:
                            pass
            ...
            for filename4 in glob.glob('C:/FH/camera4/*'):
                for path4 in glob.glob(filename4 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        try:
                            img4_orgin =img4_orgin[:,100:2248]
                        except:
                            pass
                        ...
                        if myresult4 == 0:
                            ...
                            if values['have_save_NG_4']:
                                ...
                                # try:
                                #     today = date.today()
                                #     if not os.path.isdir("D:/4/" + str(today)):
                                #         os.mkdir("D:/4/" + str(today))

                                #     cv2.imwrite("D:/4/"  + str(today) + '/' + name_folder_ng + '.jpg',show4)
                                # except:
                                #     pass
                            new_key = time.time()
                            d[new_key] = 1  
...
try:
    while True:
        ...
        try:
            # Tìm key cần xóa
            delete_keys = [k for k in d if k < time.time() - 3600]

            # Xóa các key cần xóa
            for k in delete_keys:
                del d[k]

            # Tính tổng các value còn lại trong dict
            total = sum(d.values())

            if total > 50:
                with open("C:/Users/Administrator/Desktop/excel/notification/notification.txt", "w") as f:
                    f.write("1")
        except:
            pass
