                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        while type(img1_orgin) == type(None):
                            ...
                            for path1 in glob.glob(filename1 + '/*'):
                                img1_orgin = cv2.imread(path1)
                        try:
                            img1_orgin = img1_orgin[12:1162,160:1402]
                        except:
                            pass
                            ...
                            for i1 in range(len(model1.names)):
                                if values[f'{model1.names[i1]}_1'] == True:
                                    ...
                                    if values[f'{model1.names[i1]}_NG_1'] == True:
                                        ...
                                        if label_name == model1.names[i1]:
                                            if not (
                                                        width1 > int(values[f'{model1.names[i1]}_Wn_1'])
                                                        and width1 < int(values[f'{model1.names[i1]}_Wx_1'])
                                                    ) and not (
                                                        height1 > int(values[f'{model1.names[i1]}_Hn_1'])
                                                        and height1 < int(values[f'{model1.names[i1]}_Hx_1'])
                                                    ): 
                                                table1.drop(item, axis=0, inplace=True)
                                                area_remove1.append(item)
                                            elif conf1 < int(values[f'{model1.names[i1]}_Conf_1']):
                                                table1.drop(item, axis=0, inplace=True)
                                                area_remove1.append(item)   
                                    elif values[f'{model1.names[i1]}_OK_1'] == True:
                        ...
                        if myresult1 == 0:
                            ...
                            if values['have_save_OK_1']:
                                try:
                                    ...
                                    cv2.imwrite(values['save_OK_1']  + "/" + str(today) + '/' + name_folder_ng + '.jpg',img1_save)
                                except:
                                    pass
                        else:
                            if values['have_save_NG_1']:
                ...
                for path2 in glob.glob(filename2 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        for item in range(len(table2.index)):
                            ...
                            #             if label_name == model2.names[i2]:
                            #                 if not (
                            #                             width2 > int(values[f'{model2.names[i2]}_Wn_2'])
                            #                             and width2 < int(values[f'{model2.names[i2]}_Wx_2'])
                            #                         ) and not (
                            #                             height2 > int(values[f'{model2.names[i2]}_Hn_2'])
                            #                             and height2 < int(values[f'{model2.names[i2]}_Hx_2'])
                            #                         ): 
                            #                     table2.drop(item, axis=0, inplace=True)
                            #                     area_remove2.append(item)
                            #                 elif conf2 < int(values[f'{model2.names[i2]}_Conf_2']):
                            #                     table2.drop(item, axis=0, inplace=True)
                            #                     area_remove2.append(item)   
                            #         elif values[f'{model2.names[i2]}_OK_2'] == True:
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        for item in range(len(table3.index)):
                            ...
                            # for i3 in range(len(model3.names)):
                                ...
                                #         if label_name == model3.names[i3]:
                                #             if not (
                                #                         width3 > int(values[f'{model3.names[i3]}_Wn_3'])
                                #                         and width3 < int(values[f'{model3.names[i3]}_Wx_3'])
                                #                     ) and not (
                                #                         height3 > int(values[f'{model3.names[i3]}_Hn_3'])
                                #                         and height3 < int(values[f'{model3.names[i3]}_Hx_3'])
                                #                     ): 
                                #                 table3.drop(item, axis=0, inplace=True)
                                #                 area_remove3.append(item)
                                #             elif conf3 < int(values[f'{model3.names[i3]}_Conf_3']):
                                #                 table3.drop(item, axis=0, inplace=True)
                                #                 area_remove3.append(item)   
                                #     elif values[f'{model3.names[i3]}_OK_3'] == True:
                        ...
                        if myresult3 == 0:
                            ...
                            if values['have_save_OK_3']:
                                try:
                                    name_folder_ng = time_to_name()
                                    today = datetime.date.today()
                                    if not os.path.isdir(values['save_OK_3']  + "/" + str(today)):
                                        os.mkdir(values['save_OK_3']  + "/" + str(today))

                                    cv2.imwrite(values['save_OK_3']  + "/" + str(today) + '/' + name_folder_ng + '.jpg',img3_save)
                                except:
                                    pass
                        else:
                            if values['have_save_NG_3']:
                                try:
                                    name_folder_ng = time_to_name()
                                    today = datetime.date.today()
                                    if not os.path.isdir(values['save_NG_3']  + "/" + str(today)):
                                        os.mkdir(values['save_NG_3']  + "/" + str(today))
        
                                    cv2.imwrite(values['save_NG_3']  + "/" + str(today)  + '/' + name_folder_ng + '.jpg',img3_save)                            
                                except:
                                    pass
            ...
            for filename4 in glob.glob('C:/FH/camera4/*'):
                for path4 in glob.glob(filename4 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        try:
                            img4_orgin =img4_orgin[:2030,160:2270]
                        except:
                            pass
                            ...
                            for i4 in range(len(model4.names)):
                                if values[f'{model4.names[i4]}_4'] == True:
                                    ...
                                    if values[f'{model4.names[i4]}_NG_4'] == True:
                                        ...
                                        if label_name == model4.names[i4]:
                                            if not (
                                                        width4 > int(values[f'{model4.names[i4]}_Wn_4'])
                                                        and width4 < int(values[f'{model4.names[i4]}_Wx_4'])
                                                    ) and not (
                                                        height4 > int(values[f'{model4.names[i4]}_Hn_4'])
                                                        and height4 < int(values[f'{model4.names[i4]}_Hx_4'])
                                                    ): 
                                                table4.drop(item, axis=0, inplace=True)
                                                area_remove4.append(item)
                                            elif conf4 < int(values[f'{model4.names[i4]}_Conf_4']):
                                                table4.drop(item, axis=0, inplace=True)
                                                area_remove4.append(item)   
                                    elif values[f'{model4.names[i4]}_OK_4'] == True:
                        ...
                        show4_1 = cv2.cvtColor(show4_1, cv2.COLOR_BGR2RGB)
                        #ta = time.time()
                        for i4 in range(len(model4.names)):
                        ...
                        if myresult4 == 0:
                            ...
                            if values['have_save_OK_4']:
                                try:
                                    name_folder_ng = time_to_name()
                                    today = datetime.date.today()
                                    if not os.path.isdir(values['save_OK_4']  + "/" + str(today)):
                                        os.mkdir(values['save_OK_4']  + "/" + str(today))

                                    cv2.imwrite(values['save_OK_4']  + "/" + str(today) + '/' + name_folder_ng + '.jpg',img4_save)
                                except:
                                    pass
                        else:
                            if values['have_save_NG_4']:
                                try:
                                    name_folder_ng = time_to_name()
                                    today = datetime.date.today()
                                    if not os.path.isdir(values['save_NG_4']  + "/" + str(today)):
                                        os.mkdir(values['save_NG_4']  + "/" + str(today))
        
                                    cv2.imwrite(values['save_NG_4']  + "/" + str(today)  + '/' + name_folder_ng + '.jpg',img4_save)                            
                                except:
                                    pass
...
def excel_pp(var_plc):
    ...
    if not os.path.isfile(f"excel/pp/{mydate}_ppbydate.xlsx"):
        ...
        try:
            shutil.copy(f"excel/pp/{mydate}_ppbydate.xlsx", f"C:/Users/Administrator/Desktop/excel/pp/{mydate}_ppbydate.xlsx")
        except:
            pass
...
# image_width_display = int(screen_width*0.3)
# image_height_display = int(screen_height*0.23)
# size_x = 6
# font_size = 12     
def make_window(theme):
    ...
    layout_main = [
        ...
        sg.Frame('',[
            ...
            [sg.Frame('',[
                # [sg.Button('Webcam', size=(6,1),  font=('Helvetica',10),disabled=True ,key= 'Webcam1'),sg.Text(' '), sg.Button('Change', size=(6,1), font=('Helvetica',10), disabled= True, key= 'Change1')],
                # [sg.Text('')],
                # [sg.Button('Stop', size=(6,1), font=('Helvetica',10),disabled=True ,key= 'Stop1'), 
                [sg.Text(' '),sg.Button('Pic', size=(6,1), font=('Helvetica',10),disabled=True,key= 'Pic1'),
                # [sg.Text('')],
                # [sg.Button('Snap', size=(6,1), font=('Helvetica',10),disabled=True ,key= 'Snap1'), 
                sg.Text(' '),sg.Button('Detect', size=(6,1), font=('Helvetica',10),disabled=True,key= 'Detect1'),
                # [sg.Text('')],
                # [sg.Checkbox('Check',size=(4,1),font=('Helvetica',10), key='check_model1',enable_events=True,expand_x=True, expand_y=True),
                sg.Combo(values=['1','2','3','4','5','6','7','8','9'], default_value='1',font=('Helvetica',10),size=(5, 50),text_color='navy',enable_events= True, key='choose_model')],
                [sg.Text('',font=('Helvetica',int(70/1.7)), justification='center', key='result_cam1',expand_x=True)],
                [sg.Text('',font=('Helvetica',int(25/1.7)), justification='center', key='time_cam1', expand_x=True)],
        ...
        sg.Frame('',[
            ...
            [sg.Frame('',[
                # [sg.Button('Webcam', size=(6,1),  font=('Helvetica',10),disabled=True ,key= 'Webcam2'),
                #  [sg.Text(' '), sg.Button('Change', size=(6,1), font=('Helvetica',10), disabled= True, key= 'Change2')],
                # [sg.Text('')],
                # [sg.Button('Stop', size=(6,1), font=('Helvetica',10),disabled=True ,key= 'Stop2'), 
                 [sg.Text(' '),sg.Button('Pic', size=(6,1), font=('Helvetica',10),disabled=True,key= 'Pic2'),
                # [sg.Text('')],
                # [sg.Button('Snap', size=(6,1), font=('Helvetica',10),disabled=True ,key= 'Snap2'), 
                 sg.Text(' '),sg.Button('Detect', size=(6,1), font=('Helvetica',10),disabled=True,key= 'Detect2')],
                # [sg.Text('')],
                # [sg.Checkbox('Check',size=(4,1),font=('Helvetica',10), key='check_model2',enable_events=True,expand_x=True, expand_y=True),sg.Text(' '*25)],
        ...
        sg.Frame('',[
            ...
            [sg.Frame('',[
                # [sg.Button('Webcam', size=(6,1),  font=('Helvetica',10),disabled=True ,key= 'Webcam3'),sg.Text(' '), sg.Button('Change', size=(6,1), font=('Helvetica',10), disabled= True, key= 'Change3')],
                # [sg.Text('')],
                # [sg.Button('Stop', size=(6,1), font=('Helvetica',10),disabled=True ,key= 'Stop3'), 
                 [sg.Text(' '),sg.Button('Pic', size=(6,1), font=('Helvetica',10),disabled=True,key= 'Pic3'),
                # [sg.Text('')],
                # [sg.Button('Snap', size=(6,1), font=('Helvetica',10),disabled=True ,key= 'Snap3'), 
                 sg.Text(' '),sg.Button('Detect', size=(6,1), font=('Helvetica',10),disabled=True,key= 'Detect3')],
                # [sg.Text('')],
                # [sg.Checkbox('Check',size=(4,1),font=('Helvetica',10), key='check_model3',enable_events=True,expand_x=True, expand_y=True),sg.Text(' '*25)],
        ...
        sg.Frame('',[
            ...
            [sg.Frame('',[
                # [sg.Button('Webcam', size=(6,1),  font=('Helvetica',10),disabled=True ,key= 'Webcam4'),sg.Text(' '), sg.Button('Change', size=(6,1), font=('Helvetica',10), disabled= True, key= 'Change4')],
                # [sg.Text('')],
                # [sg.Button('Stop', size=(6,1), font=('Helvetica',10),disabled=True ,key= 'Stop4'), 
                 [sg.Text(' '),sg.Button('Pic', size=(6,1), font=('Helvetica',10),disabled=True,key= 'Pic4'),
                # [sg.Text('')],
                # [sg.Button('Snap', size=(6,1), font=('Helvetica',10),disabled=True ,key= 'Snap4'), 
                 sg.Text(' '),sg.Button('Detect', size=(6,1), font=('Helvetica',10),disabled=True,key= 'Detect4')],
                # [sg.Text('')],
                # [sg.Checkbox('Check',size=(4,1),font=('Helvetica',10), key='check_model4',enable_events=True,expand_x=True, expand_y=True),sg.Text(' '*25)],
    ...
    layout_option1a = [[sg.Column(layout_option1a,scrollable = True)]]
    layout_option1b = [[sg.Column(layout_option1b,scrollable = True)]]
    ...
    layout_option4 = [[sg.Column(layout_option4, scrollable=True)]]
    
    try:
        layout_option4 = [[sg.Column(layout_option4, scrollable=True,size = (1000,1000))]]
    except:
        layout_option4 = [[sg.Column(layout_option4, scrollable=True)]]
    ...
    window = sg.Window('HuynhLeVu', layout, location=(0,0),right_click_menu=right_click_menu,resizable=True,size = (screen_width//3*2, screen_height)).Finalize()
...
# result_width_display = int(470)
# result_height_display = int(100)

# image_width_display = int(650/1.7)
# image_height_display = int(410/1.7)

result_width_display = int(70/1.7)
result_height_display = int(100/1.7)
...
try:
    ...
    window['time_cam1'].update(value= "Erect_ror data") 
...
try:
    while True:
        ...
        #moplc
        program_camera1_FH(model=model1,size= 768,conf= values['conf_thres1']/100)
        ...
        # print("bien DM3132: ", readdata('DM3132'))
        try:
            if readdata('DM3132') == 1:
                for var_plc in range(32):
                    if var_plc < 10:
                        if readdata(f'DM310{var_plc}') == 1:
                            excel_pp(var_plc)
                            writedata(f'DM310{var_plc}',0) 
                    else:
                        if readdata(f'DM31{var_plc}') == 1:
                            excel_pp(var_plc)
                            writedata(f'DM31{var_plc}',0) 
                writedata('DM3132.U',0) 
                ...
                for path4 in glob.glob('C:/Check4/*'):
                    ...
                    for i4 in range(len(model4.names)):
                        ...
                        if values[f'{model4.names[i4]}_OK_4'] == True:
                            ...
                            if model4.names[i4] in names4:
                                print('NG')
                                cv2.putText(show4, 'NG',(resulrecording1t_width_display,result_height_display),cv2.FONT_HERSHEY_COMPLEX, 4,(0,0,255),5)
                                window['result_cam4'].update(value= 'NG', text_color='red')    
                                myresult4 = 1         
